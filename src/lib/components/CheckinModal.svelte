<script lang="ts">
    ...
    import type { Dog, Variation } from "$lib/api/client";
    import * as api from "$lib/api/client";
    import { authToken } from "$lib/stores/auth";
    import { variations, spaVariations } from "$lib/stores/app";
...
>
    <div class="modal-content">
        ...
        <div class="modal-body">
            <!-- Dog Info - Horizontal Layout -->
            <div class="selected-dog-info-horizontal">
                <div class="selected-dog-photo-large">
                    {#if dog.photo}
                        <img
                ...
                <div class="selected-dog-details-right">
                    <h3 class="dog-name-modal">
                        {dog.first_name ||
                    ...
                    <p class="dog-owner-modal">
                        Owner: {dog.owner_first_name || ""}
                        {dog.owner_last_name || ""}
                    </p>
                    <p class="dog-details-modal">
